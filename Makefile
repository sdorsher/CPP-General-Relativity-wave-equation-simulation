...
dg1D : main.o GridFunction.o ReferenceElement.o VectorGridFunction.o Grid.o Evolution.o globals.o ConfigParams.o
	$(CXX) -g -lm -std=c++11 $(ITNT) $(IGEN) main.o GridFunction.o ReferenceElement.o VectorGridFunction.o Grid.o Evolution.o globals.o ConfigParams.o -o dg1D

main.o: main.cpp GridFunction.h ReferenceElement.h VectorGridFunction.h TNT2.h
	$(CXX) -g -lm -std=c++11 $(ITNT) $(IGEN) -c main.cpp ConfigParams.h
...
ConfigParams.o: ConfigParams.cpp ConfigParams.h
	$(CXX) -g -lm -std=c++11 $(ITNT) $(IGEN) -c ConfigParams.cpp